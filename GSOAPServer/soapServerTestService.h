...
#ifndef soapServerTestService_H
#define soapServerTestService_H
#include "soapH.h"

    class SOAP_CMAC ServerTestService : public soap {
      public:
        /// Variables globally declared in ServerTest.h, if any
        /// Construct a service with new managing context
        ServerTestService();
        /// Copy constructor
        ServerTestService(const ServerTestService&);
        /// Construct service given a managing context
        ServerTestService(const struct soap&);
        /// Constructor taking input+output mode flags for the new managing context
        ServerTestService(soap_mode iomode);
        /// Constructor taking input and output mode flags for the new managing context
        ServerTestService(soap_mode imode, soap_mode omode);
        /// Destructor deletes deserialized data and managing context
        virtual ~ServerTestService();
        /// Delete all deserialized data (with soap_destroy() and soap_end())
        virtual void destroy();
        /// Delete all deserialized data and reset to defaults
        virtual void reset();
        /// Initializer used by constructors
        virtual void ServerTestService_init(soap_mode imode, soap_mode omode);
        /// Return a copy that has a new managing context with the same engine state
        virtual ServerTestService *copy() SOAP_PURE_VIRTUAL;
        /// Copy assignment
        ServerTestService& operator=(const ServerTestService&);
        ...
        virtual int add(int a, int b, int &c) SOAP_PURE_VIRTUAL;
        /// Web service operation 'sub' (returns SOAP_OK or error code)
        virtual int sub(int a, int b, int &c) SOAP_PURE_VIRTUAL;
    };
#endif
